      ...
      <section class="container mx-auto">
        <div class="flex flex-wrap my-4 md:my-12">
          ...
          <div class="flex-1">
            <div class="slider">
              <div class="thumbnail">
                ...
                <div class="px-2">
                  <div
                    class="item {{ $loop->first }}"
                    data-img="{{ $item->url }}"
                  >
                    <img
                      src="{{ $product->galleries->first()->url }}"
                      alt="front"
          ...
          <div class="flex-1 px-4 md:p-6">
            ...
            <p class="text-xl">{{ number_format($product->price) }}</p>
            <form action="{{ route('cartStore', $product->id) }}"
              method="post">
              @csrf
              @method('POST')
              <button type="submit"
