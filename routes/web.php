...
Route::get('/detail-product/{slug}', [FrontEndController::class, 'detailProducts'])->name('detailProducts');
Route::get('/detail-category/{slug}', [FrontEndController::class, 'detailCategorys'])->name('detailCategorys');
